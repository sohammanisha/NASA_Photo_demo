...
// Search with specific date range not working while fetching from NASA API URL.
//const response = await axios.get(`${NASA_APOD_URL}`, {
//		params: {
//			api_key: NASA_API_KEY,
//			start_date: moment("2020-01-01").format("YYYY-MM-DD"),
//			end_date: moment("2024-12-31").format("YYYY-MM-DD")
//		}
//	});
let photos = response.data; 
photos = defineSearchByTitleFilter(photos, search);
//photos = defineSearchByDateFilter(photos, date) ;
