...
import PhotoGallery from "./PhotoGallery";
 ...
 const timer = setTimeout(() => { alert("You have been logged out due to inactivity."); handleLogout(); }, 10 * 60 * 1000); 
 // 10 minutes default log out time. 
 ...
 <Route path="/gallery" element={user ? <PhotoGallery resetTimer={startLogoutTimer} /> : <Navigate to="/login" />} /> 
